    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{route('users.update')}}">
          ...
          <div class="mb-3">
            <label class="form-label" for="basic-default-company">Contraseña antigua</label>
            <input type="password" name="old_password" class="form-control" id="basic-default-password"  />
            <div class="form-text"> You can use letters, numbers & periods </div>
          </div>

          <div class="mb-3">
            <label class="form-label" for="basic-default-company">Contraseña nueva</label>
            <input type="password" name="new_password" class="form-control" id="basic-default-company"  />
          </div>
